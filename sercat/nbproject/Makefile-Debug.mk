...
../bin/sercat: ${OBJECTFILES}
	${MKDIR} -p ../bin
	${LINK.cc} -o ../bin/sercat ${OBJECTFILES} ${LDLIBSOPTIONS} -Wall -Wpedantic

${OBJECTDIR}/src/GQDevice.o: src/GQDevice.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iutillib/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GQDevice.o src/GQDevice.cpp

${OBJECTDIR}/src/GQSerial.o: src/GQSerial.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iutillib/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GQSerial.o src/GQSerial.cpp

${OBJECTDIR}/src/GQSerial.hpp.gch: src/GQSerial.hpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iutillib/include -MMD -MP -MF "$@.d" -o "$@" src/GQSerial.hpp

${OBJECTDIR}/src/config.o: src/config.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iutillib/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/config.o src/config.cpp

${OBJECTDIR}/src/main.o: src/main.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iutillib/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.cpp

${OBJECTDIR}/utillib/File.o: utillib/File.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/utillib
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iutillib/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utillib/File.o utillib/File.cpp

${OBJECTDIR}/utillib/Serial.o: utillib/Serial.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/utillib
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iutillib/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utillib/Serial.o utillib/Serial.cpp

${OBJECTDIR}/utillib/exception.o: utillib/exception.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/utillib
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iutillib/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utillib/exception.o utillib/exception.cpp

${OBJECTDIR}/utillib/util.o: utillib/util.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/utillib
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iutillib/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utillib/util.o utillib/util.cpp
